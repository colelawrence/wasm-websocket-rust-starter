...
export namespace Format {
  ...
  export function apply<R>(to: ApplyFns<R>): (input: Format) => R {
  ...
  /** Match helper for {@link Format} */
  export function match<R>(input: Format, to: ApplyFns<R>): R {
...
export namespace ContainerFormat {
  ...
  export function apply<R>(to: ApplyFns<R>): (input: ContainerFormat) => R {
    return function _match(input): R {
      // if-else strings
  ...
  /** Match helper for {@link ContainerFormat} */
  export function match<R>(input: ContainerFormat, to: ApplyFns<R>): R {
    return apply(to)(input);
  }
  /** An empty struct, e.g. `struct A`. */
...
export namespace VariantFormat {
  ...
  export function apply<R>(to: ApplyFns<R>): (input: VariantFormat) => R {
    return function _match(input): R {
      // if-else strings
      if (input === "Unit") return to.Unit();
      // if-else objects
  ...
  /** Match helper for {@link VariantFormat} */
  export function match<R>(input: VariantFormat, to: ApplyFns<R>): R {
    return apply(to)(input);
  }
  /** A variant without parameters, e.g. `A` in `enum X { A }` */
  export type Unit = "Unit";
 ...
 * `#[codegen(tags = "derive-codegen-internal")]`
 */
export type VariantFormat = VariantFormat.Unit | VariantFormat.NewType | VariantFormat.Tuple | VariantFormat.Struct;
/** `#[codegen(tags = "derive-codegen-internal")]` */
export type Attrs = {
  /**
   ...
   */
  rust_docs?: string | undefined | null;
  /**
...
export namespace EnumRepresentation {
  ...
  export function apply<R>(to: ApplyFns<R>): (input: EnumRepresentation) => R {
    return function _match(input): R {
      // if-else strings
  ...
  /** Match helper for {@link EnumRepresentation} */
  export function match<R>(input: EnumRepresentation, to: ApplyFns<R>): R {
    return apply(to)(input);
  }
  /**
   * The default
  ...
  export type Tagged = {
    Tagged: {
      ...
      content_location?: LocationID | undefined | null;
    };
  };
  /**
   * e.g `{ type: "User", id: 1200, name: "Smithy" }`
...
/** `#[codegen(tags = "derive-codegen-internal")]` */
export type EnumRepresentation = EnumRepresentation.External | EnumRepresentation.Untagged | EnumRepresentation.Tagged;
